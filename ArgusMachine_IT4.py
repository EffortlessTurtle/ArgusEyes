#       <YArgusMachine, webscraper to pull news stories, v0.04>
#
...
#You'll need to set the destination path or this whole thing doesn't work
fo = open(f'//Desktop/News/{str(dt.date.today())}.txt', "w")
