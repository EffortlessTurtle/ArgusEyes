#       <ArgusEyes,webscraper for news stories,v0.25,Working,EffortlessTurtle>
########################################################################
#       <TODO>
...
class Quill: #For the write to file section of a FXN
    ...
    def title_write(name,fo): #Writes the of the title of site with different format to file.
        ...
        fo.write(140 * "^" + '\n\n')
    def csv_file_prep(fo): #Preps files as CSV file <- MARK
...
def US_Army_news(fo):        #Pulls title, blurb and date for US Army News
...
def yahoo_fin_RSS_rich(fo): #Pulls yahoo finance RSS and site <- MARK
