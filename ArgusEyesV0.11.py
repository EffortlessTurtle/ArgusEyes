#       <ArgusEyes, webscraper for news stories, v0.11,GitHub,EffortlessTurtle>
########################################################################
#       <TODO>
...
def nyt_US(fo):        #Pulls title, blurb and date - NYT - US
    ...
    for i in range(50):
        ...
        ##--------Big headline stuff for places like the BBC site---------
    ...
    Quill.write(p_bold_title, p_bold_more_info, date, fo)
...
#OUTPUT 22APR2022:
#
#News at: /home/nate/Desktop/news
#Fetching NYT - US: \                                                                                                                                           Traceback (most recent call last):
#  File "/ArgusMachine_IT10.py", line 1116, in <module>
#    main()
#  File "/ArgusMachine_IT10.py", line 1111, in main
#    nyt_US(fo)
#  File "/ArgusMachine_IT10.py", line 951, in nyt_US
#    p_bold_title = p_bold.find(class_=bold_title).text.strip() if p_bold.find(class_=bold_title) else ''
